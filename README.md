...
<p>
  <strong>Artificial Intelligence & Machine Learning Internship</strong><br>
  From Foundations → Machine Learning → Deep Learning → Deployment
</p>
...
│   │   └── README.md
│   ├── Day 4/
│   │   ├── day4_attention_transformers.ipynb
│   │   ├── Hands_On_Lab.ipynb
│   │   └── README.md
│   ├── Day 5/
...
* Convolution, filters, feature maps, parameter sharing
* CNN architecture: Conv+Pool blocks, data augmentation, transfer learning
* RNN hidden state, vanishing gradient, LSTM gates, GRU, embeddings
...
* [x] Day 1 — Sprint 2 Planning & CNN Introduction
* [x] Day 2 — Building CNNs & Transfer Learning (Melanoma)
* [x] Day 3 — RNNs & LSTMs (ECG Heartbeats)
* [x] Day 4 — Attention & Transformers (Medical Abstracts)
* [x] Day 5 — Sprint 2 Close-Out & Review
...
* [x] Day 1 — Medical NLP Preprocessing
* [x] Day 2 — TF-IDF & GloVe Text Representation
* [x] Day 3 — Computer Vision, CNN & Transfer Learning
* [x] Day 4 — LSTM, DistilBERT & Model Comparison
* [x] Day 5 — Data Quality, Error Analysis & SHAP Explainability
...
* [x] Day 1 — Sprint Planning, Model Retraining & Serialization
* [x] Day 2 — FastAPI Model Serving
* [x] Day 3 — Streamlit Dashboard
* [x] Day 4 — Public Deployment
* [x] Day 5 — Repository Polish, Definition of Done & Sprint Review
...
<p>
  <em>Every week was a step forward — from understanding the fundamentals<br>
  to building models, solving real problems, and deploying a complete ML project.</em>
</p>
...
<sub>BinX Tech AI & ML Internship • 2026</sub>
